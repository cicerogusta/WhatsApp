...
class ContatosFragment : BaseFragment<FragmentContatosBinding, ContatosViewModel>() {
    ...
    private fun configurarRecyclerView(it: MutableList<User>) {
        ...
        binding.recyclerViewListaContatos.addOnItemTouchListener(RecyclerItemClickListener(activity, binding.recyclerViewListaContatos, object : RecyclerItemClickListener.OnItemClickListener {
